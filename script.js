...
function speak(text){
    ...
    if(maleVoice){
        ...
        text_speak.voice = voices[0]; // fallback
    }
 ...
 function takeCommand(message){
    ...
    if(message.includes("hello")|| message.includes("hey") ){
        speak("hello sir, what can i help you?")
         ...
         speak("I am virtual assistant, created by Shivam")
       ...
       let finalText =  "this is what i found on internet regarding" +  message.replace("alpha","")
        speak(finalText)
        window.open(`https://www.google.com/search?q=${message.replace("alpha","")}`,"_blank")
    }
 }